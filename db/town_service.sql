...
CREATE INDEX IF NOT EXISTS idx_movement_time ON movement_history(movement_time DESC);
...
BEGIN
    ...
    IF loc_count = 0 THEN
        ...
        INSERT INTO movement_history (character_id, from_location_id, to_location_id, game_id)
        VALUES (
    ...
    ELSE
        RAISE NOTICE 'Database already initialized (% locations found).', loc_count;
    END IF;
END $$;
