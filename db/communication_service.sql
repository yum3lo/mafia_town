...
-- Mock data commented out - chat rooms are now auto-created via service-to-service communication
-- Chat rooms are dynamically created based on:
-- - Locations from town service
-- - Game state from game service
-- - Players are synced when they join locations
